...
var MUSIC = {
    ...
    scales: {
        ...
        'melodic minor': ['major second', 'minor third', 'fourth', 'fifth', 'major sixth', 'major seventh', 'octave', 'octave', 'minor seventh', 'minor sixth', 'fifth', 'fourth', 'minor third', 'major second', 'unison'],
        'major pentatonic': ['major second', 'major third', 'fifth', 'major sixth'],
        'minor pentatonic': ['minor third', 'fourth', 'minor sixth', 'minor seventh'],
        'major arpeggio': ['major third', 'fifth', 'major third', 'unison'],
        'minor arpeggio': ['minor third', 'fifth', 'minor third', 'unison'],
        'diminished arpeggio': ['minor third', 'diminished fifth', 'minor third', 'unison']
